...
public class ModRecipeManager {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> RECIPE_SERIALIZERS = DeferredRegister.create(BuiltInRegistries.RECIPE_SERIALIZER, MagicIO.MOD_ID);
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<ZhenRecipe>> ZHEN_RECIPE_SERIALIZER =
            RECIPE_SERIALIZERS.register("zhen_block", () -> ZhenRecipeSerializer.INSTANCE);
